        ...
        if self.seasons_split:
            ...
            for season in self.seasons:
                ...
                for k in self.n_k:
                    ...
                    plt.plot(self.n_k, bics[season], "bo-", label="BIC")
                    plt.plot(self.n_k, aics[season], "go--", label="AIC")
            ...
            plt.plot(self.n_k, bics, "bo-", label="BIC")
            plt.plot(self.n_k, aics, "go--", label="AIC")
            plt.xlabel("$k$", fontsize=14)
            plt.ylabel("Information Criterion", fontsize=14)
